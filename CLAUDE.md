...
用 WebSearch 从四个数据源搜索企业最新年度债券募集说明书。**必须确保募集书是当年或上一年度的**——数据过期则无法补充 QCC 缺口。

```
# 搜索词模板（按优先级尝试）
1. "{企业名称} 20XX年 募集说明书 site:sse.com.cn"        ← SSE 上交所（官方源）
2. "{企业名称} 募集说明书 site:money.finance.sina.com.cn" ← 新浪财经债券公告
3. "{企业名称} 募集说明书 site:data.eastmoney.com"        ← 东方财富公告
4. "{企业名称} 20XX年 债券 募集说明书 chinamoney"          ← 中国货币网
```
...
| 新浪财经 | 债券公告聚合页，按日期排序，链接直接指向 SSE PDF | 部分页面需二次跳转 |
| 东方财富 | 公告列表完整，含 PDF 附件下载 | WebFetch 偶有反爬 |
| chinamoney.com.cn | 银行间债券官方平台 | WebFetch 被安全策略阻止 |

**优先选择：**
1. **时效性第一**：确认 PDF 发布日期为当年或上一年（如当前 2026 年，找 2025 或 2026 年发布的募集书）
2. SSE 上交所 PDF（`static.sse.com.cn`）——无反爬限制，直接下载
3. 新浪财经债券公告页——如 `http://money.finance.sina.com.cn/bond/notice/sh{债券代码}.html` 聚合了该债券的全部公告，方便找到最新版本的募集说明书
4. 如果找不到募集书，降级使用年度报告 PDF 或信用评级报告 PDF
