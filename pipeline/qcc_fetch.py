    ...
    for item in items[:20]:
        if isinstance(item, dict):
            ...
            rows.append({
                ...
                '_status': 'green',
                '_column_status': {'子公司名称': 'green', '层级': 'green', '业务板块': 'yellow', '持股比例': 'green', '备注': 'yellow'},
            })
            ...
            'chapter2': {
                ...
                '（1）总体资金管理模式': {'tables': [
                    {
                        ...
                        'type': 'list',
                        'data': [
                            {'子公司名称': '(待QCC投资数据)', '层级': '', '业务板块': '', '持股比例': '', '备注': '数据采集后自动填充', '_status': 'yellow'},
                        ],
                        '_columns_brief': '子公司名称🟢 | 层级🟢 | 业务板块🟡 | 持股比例🟢 | 备注🟡',
                    },
                    {
                        'title': '客户合作准入方式',
                        'type': 'kv',
                ...
                '（2）债券及其他融资情况': {'tables': [
                    ...
                    },
                    {
                        ...
                        'type': 'list',
                        'data': [
                            {'债券类型': '信用债(公司债/中票/短融)', '发行金额(万元)': '', '平均利率(%)': '', '发行时间': '', '备注': '', '_status': 'yellow'},
                            {'债券类型': '绿色债券',                 '发行金额(万元)': '', '平均利率(%)': '', '发行时间': '', '备注': '', '_status': 'yellow'},
                            {'债券类型': '其他类型',                 '发行金额(万元)': '', '平均利率(%)': '', '发行时间': '', '备注': '', '_status': 'yellow'},
                        ],
                    },
                    {
                        'title': '存续期债券明细',
                ...
                '（3）与我行及同业合作情况': {'tables': [
                    ...
                    },
                    {
                        ...
                        'type': 'list',
                        'data': [
                            {'银行': '我行',       '短期贷款余额': '', '长期贷款余额': '', '临期贷款': '', '排名/占比': '', '_status': 'red'},
                            {'银行': '主要竞争行',  '短期贷款余额': '', '长期贷款余额': '', '临期贷款': '', '排名/占比': '', '_status': 'red'},
                            {'银行': '全行业平均',  '短期贷款余额': '', '长期贷款余额': '', '临期贷款': '', '排名/占比': '', '_status': 'red'},
                        ],
                    },
                    {
                        'title': '特色产品合作',
                    ...
                    # --- 我行合作情况 ---
                    {
                        ...
                        'type': 'kv',
                        'data': [
                            {'合作维度': '授信额度(万元)',          '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '合作板块/合作年限',       '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '已获批单业务金额(万元)',  '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '合同金额/贷款余额',       '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '利率水平(%)',            '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '期限/到期日',            '内容(含趋势对比)': '', '_status': 'red'},
                            {'合作维度': '担保方式',               '内容(含趋势对比)': '', '_status': 'red'},
                        ],
                    },
                    {
                        'title': '存款与银企直联业务',
                        'type': 'list',
                        'data': [
                            {'指标': '日均存款(万元)',        '当前值': '', '合作初期': '', '趋势': '', '_status': 'red'},
                            {'指标': '期末存款余额(万元)',    '当前值': '', '合作初期': '', '趋势': '', '_status': 'red'},
                            {'指标': '活期/定期占比(%)',      '当前值': '', '合作初期': '', '趋势': '', '_status': 'red'},
                            {'指标': '加挂成员单位(家)',      '当前值': '', '合作初期': '', '趋势': '', '_status': 'red'},
                            {'指标': '结算量',                '当前值': '', '合作初期': '', '趋势': '', '_status': 'red'},
                        ],
                    },
                    {
                        'title': '客户集中度',
                        'type': 'kv',
                        'data': [
                            {'信息项': '贷款/存款集中度占比及趋势', '内容': '', '备注/来源': '[内部系统]', '_status': 'red'},
                        ],
                    },
                    {
                        'title': '其他业务',
                        'type': 'list',
                        'data': [
                            {'产品/服务': '第三代社保卡', '合作状态': '', '规模': '', '评价': '', '_status': 'red'},
                            {'产品/服务': '对公理财',     '合作状态': '', '规模': '', '评价': '', '_status': 'red'},
                            {'产品/服务': '系统建设',     '合作状态': '', '规模': '', '评价': '', '_status': 'red'},
                            {'产品/服务': '特色产品',     '合作状态': '', '规模': '', '评价': '', '_status': 'red'},
                            {'产品/服务': '其他',         '合作状态': '', '规模': '', '评价': '', '_status': 'red'},
                        ],
                    },
                    # --- 同业对标 ---
                    {
                        ...
                        'type': 'list',
                        'data': [
                            {'对标维度': '授信占比(%)',        '我行数据': '', '同业标杆': '', '差距分析': '', '_status': 'red'},
                            {'对标维度': '融资利率(%)',        '我行数据': '', '同业标杆': '', '差距分析': '', '_status': 'red'},
                            {'对标维度': '存款产品覆盖度',     '我行数据': '', '同业标杆': '', '差距分析': '', '_status': 'red'},
                            {'对标维度': '数字化接入完成度',   '我行数据': '', '同业标杆': '', '差距分析': '', '_status': 'red'},
                        ],
                    },
                ]},
            },
